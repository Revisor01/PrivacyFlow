...
- [ ] **UX-01**: Account-Switcher im Dashboard als kompakter Button in der Header-Zeile (neben + und Graph-Switcher) statt als großer Bereich
- [ ] **UX-02**: "Abbrechen"-Button im Account-Hinzufügen-Modal entfernen wenn vom Account-Switcher geöffnet
